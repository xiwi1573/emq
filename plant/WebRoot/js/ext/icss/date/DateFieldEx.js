...
* @param {Object} config
 */
Ext.form.DateFieldEx = Ext.extend(Ext.form.TriggerField,  {
    /**
     * @cfg {String} format
    ...
    validateValue : function(value){
        ...
        if(!Ext.form.DateFieldEx.superclass.validateValue.call(this, value)){
            return false;
        }
     ...
     */
    getValue : function(){
        return this.parseDate(Ext.form.DateFieldEx.superclass.getValue.call(this)) || "";
    },
...
dateField.setValue('2006-5-4');
    ...
    setValue : function(date){
        Ext.form.DateFieldEx.superclass.setValue.call(this, this.formatDate(this.parseDate(date)));
    ...
    parseDate : function(value){
        ...
        var fmt = null;
        if(this.format == 'Y-m' && typeof(value)=='string' ){
    ...
    onDestroy : function(){
        ...
        Ext.form.DateFieldEx.superclass.onDestroy.call(this);
    },
    ...
    menuListeners : {
        select: function(m, d){
            this.setValue(d);
            this.fireEvent('setvalue',this,d);
        },
    ...
    onTriggerClick : function(){
        ...
        if(this.menu == null){
            this.menu = new Ext.menu.DateMenuEx({format:this.format});
        }
