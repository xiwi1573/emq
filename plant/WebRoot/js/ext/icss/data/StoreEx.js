 ...
 */
Ext.data.StoreEx = function(config){
    this.data = new Ext.util.MixedCollectionEx(false);
 ...
 Ext.data.Record.COMMIT
    ...
    Ext.data.StoreEx.superclass.constructor.call(this);
...
Ext.extend(Ext.data.StoreEx, Ext.util.Observable, {
    /**
