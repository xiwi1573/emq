...
Ext.extend(Ext.ux.grid.GridSummary, Ext.util.Observable, {
  ...
  calculate : function(rs, cs) {
    var data = {}, cfg = this.cm.config;
    for (var i = 0, len = cs.length; i < len; i++) { // loop through all columns in ColumnModel
      var c = cs[i], // get a single column
