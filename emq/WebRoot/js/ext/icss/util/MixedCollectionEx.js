...
/**
 * @class Ext.util.MixedCollectionEx
 * @extends Ext.util.Observable
 * A Collection class that maintains both numeric indexes and keys and exposes events.
 * @constructor
 * @param {Boolean} allowFunctions True if the addAll function should add function references to the
 * collection (defaults to false)
 * @param {Function} keyFn A function that can accept an item of the type(s) stored in this MixedCollectionEx
 * and return the key value for that item.  This is used when available to look up the key on items that
 * were passed without an explicit key parameter to a MixedCollectionEx method.  Passing this parameter is
 * equivalent to providing an implementation for the {@link #getKey} method.
 */
Ext.util.MixedCollectionEx = function(allowFunctions, keyFn){
    this.items = [];
    this.map = {};
    this.keys = [];
    this.length = 0;
    ...
    Ext.util.MixedCollectionEx.superclass.constructor.call(this);
};

Ext.extend(Ext.util.MixedCollectionEx, Ext.util.Observable, {
    allowFunctions : false,

/**
 * Adds an item to the collection. Fires the {@link #add} event when complete.
 * @param {String} key <p>The key to associate with the item, or the new item.</p>
 * <p>If you supplied a {@link #getKey) implementation for this MixedCollectionEx, or if the key
 * of your stored items is in a property called <tt><b>id</b></tt>, then the MixedCollectionEx
...
/**
  * MixedCollectionEx has a generic way to fetch keys if you implement getKey.  The default implementation
...
<pre><code>
// normal way
var mc = new Ext.util.MixedCollectionEx();
...
var mc = new Ext.util.MixedCollectionEx(false, function(el){
   return el.dom.id;
});
mc.add(someEl);
mc.add(otherEl);
 ...
 */
    ...
    _sort : function(property, dir, fn){
        ...
        for(var i = this.fixedRows, len = items.length; i < len; i++){
     ...
     * @return {MixedCollectionEx} The new filtered collection
     */
    ...
    filterBy : function(fn, scope){
        var r = new Ext.util.MixedCollectionEx();
 ...
 * @return {Object} The item associated with the passed key.
 */
Ext.util.MixedCollectionEx.prototype.get = Ext.util.MixedCollectionEx.prototype.item;